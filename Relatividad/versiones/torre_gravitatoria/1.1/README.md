...
- `assets/`: gráficos raster usados por las simulaciones, incluyendo la bicicleta, ruedas, manzana, cara de Einstein, fondos del ascensor, árboles, sendero de tierra, muón, Tierra realista, torre gravitatoria y paisaje alpino.
