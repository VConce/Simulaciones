...
- La escala temporal debe iniciar en `1 s/s` y usa anclas calibradas: `1 s/s`, `1 h/s`, `1 d?a/s`, `1 a?o/s` y `1 d?cada/s`; las etiquetas del deslizador deben corresponder con esos factores reales.
