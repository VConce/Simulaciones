...
- `assets/`: gráficos raster usados por las simulaciones, especialmente la bicicleta de Einstein.
...
La reorganización actual queda marcada como versión `2.0`.

La raíz de `Relatividad` contiene la versión activa. La carpeta `versiones/2.0` contiene una copia congelada de este punto de partida.
