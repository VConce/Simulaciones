...
Esta copia procede de `EM_Codex_3.2.html`, que a su vez procede de `simulador_campo_electrico_compacto_Antigravity.html`. La version activa debe vivir directamente en `SimulaciónElecMag` para que las rutas relativas `assets/electric/...` funcionen. Las versiones anteriores se guardan en `Versiones`.

## Estructura de la carpeta

- `simulador_campo_electrico_compacto_Antigravity.html`: version recibida de Antigravity. Es el origen de `EM_Codex_2.0`.
- `EM_Codex_3.3.html`: version activa actual.
- `EM_Codex_3.3_compacto.html`: copia de envio con PNG locales incrustados en base64.
